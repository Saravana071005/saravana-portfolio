...
function initContactForm() {
  ...
  form.addEventListener('submit', (e) => {
    ...
    const mailtoLink = 'mailto:saravanakumar0701h@gmail.com?subject=' + encodeURIComponent(subject || 'Portfolio Inquiry from ' + name) + '&body=' + encodeURIComponent(bodyContent);
...
/* ==========================================================================
   10. ONE-CLICK CLIPBOARD ACTIONS
   ========================================================================== */
